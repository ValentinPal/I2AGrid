...
if __name__ == "__main__":
    ...
    parser.add_argument("-e", "--EM_FILE", required=False, help="Environment model file name", default="repl/5_14/#Jan08_02-34-14_valy_em_14_5/best_4.3502e-03_136624.dat")
