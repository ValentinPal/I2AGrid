...
class EnvironmentModel(nn.Module):
    def __init__(self, input_shape, n_actions):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(n_planes, 32, kernel_size=5, stride=2),
            nn.ReLU(),
        ...
        self.deconv = nn.ConvTranspose2d(32, 3, kernel_size=5, stride=2)
...
#            nn.MaxPool2d(2),
    ...
    def forward(self, imgs, actions):
        ...
        #creates an zeroed out plane/matrix for each action
...
#        self.encoder = RolloutEncoder(EM_OUT_SHAPE)
        self.encoder = RolloutEncoder(common.IMG_SHAPE)
